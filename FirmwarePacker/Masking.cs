...
namespace FirmwarePacker
{
    ...
    public static class Masking
    {
        ...
        /// <param name="mask">The mask to set, or <see langword="null" /> to remove any existing mask from
        ///     <paramref name="textBox" />.</param>
        ...
        /// <remarks>
        ///     This method can be used to retrieve the actual <see cref="Regex" /> instance created as a result of setting
        ///     the mask on a <see cref="TextBox" />.
        /// </remarks>
        /// <param name="textBox">The <see cref="TextBox" /> whose mask expression is to be retrieved.</param>
        /// <returns>
        ///     The mask expression as an instance of <see cref="Regex" />, or <see langword="null" /> if no mask has been
        ///     applied to <paramref name="textBox" />.
        /// </returns>
        ...
        private static void textBox_PreviewKeyDown(object sender, KeyEventArgs e)
        {
            ...
            if (e.Key == Key.Space)
            {
                string proposedText = GetProposedText(textBox, " ");
