...
namespace FirmwareBurner.ImageFormatters.Avr
{
    ...
    {
        public AvrBootloaderInformation(AvrFuses RequiredFuses, IBodyLoader BodyLoader, Placement<AvrMemoryKind> BootloaderPlacement,
                                        Placement<AvrMemoryKind> FilesTablePlacement, Placement<AvrMemoryKind> PropertiesTablePlacement) : base(BootloaderPlacement, BodyLoader)
        {
